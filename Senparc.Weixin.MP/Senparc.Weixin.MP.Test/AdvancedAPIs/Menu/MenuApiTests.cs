...
namespace Senparc.Weixin.MP.AdvancedAPIs.Tests
{
   ...
   'selfmenu_info': { 
       'button': [ 
           ...
           // GetCurrentSelfmenuInfoResult result =new GetCurrentSelfmenuInfoResult();

            JavaScriptSerializer js = new JavaScriptSerializer();
            GetCurrentSelfmenuInfoResult result= js.Deserialize<GetCurrentSelfmenuInfoResult>(json);
